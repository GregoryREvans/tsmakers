...
timespan_maker = tsmakers.DependentTimespanMaker(
    include_inner_starts=True, include_inner_stops=True, voice_names=("Viola Voice",),
)
...
timespan_list = abjad.TimespanList(
    [
        tsmakers.PerformedTimespan(
            voice_name="Viola Voice", start_offset=(1, 4), stop_offset=(1, 1),
        ),
        tsmakers.PerformedTimespan(
            voice_name="Viola Voice", start_offset=(3, 4), stop_offset=(3, 2),
        ),
    ]
)
