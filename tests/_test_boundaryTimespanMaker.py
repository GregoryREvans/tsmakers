...
timespan_maker = tsmakers.BoundaryTimespanMaker(
    start_talea=rmakers.Talea(counts=[1], denominator=2,),
    stop_talea=rmakers.Talea(counts=[1], denominator=4,),
...
initial_list = abjad.TimespanList(
    [
        tsmakers.PerformedTimespan(
            start_offset=0, stop_offset=1, voice_name="Violin 1 Voice",
        ),
        tsmakers.PerformedTimespan(
            start_offset=(1, 2), stop_offset=(3, 2), voice_name="Violin 2 Voice",
        ),
        tsmakers.PerformedTimespan(
            start_offset=3, stop_offset=4, voice_name="Violin 2 Voice",
        ),
    ]
)
