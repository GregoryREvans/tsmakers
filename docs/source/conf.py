...
copyright = "2015-2020, Gregory Rowland Evans, Ivan Alexander Moscotta, and Josiah Wolf Oberholtzer."
exclude_patterns = []
...
htmlhelp_basename = "TsmakersAPIdoc"
...
latex_documents = [
    ("index", "TsmakersAPI.tex", "Tsmakers API", "Gregory Rowland Evans", "manual")
]
...
uqbar_api_title = "Tsmakers API"
uqbar_api_source_paths = ["tsmakers"]
